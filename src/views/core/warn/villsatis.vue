    ...
    <div v-for="(item,index) in data">
      <div class="warn-list" v-if="item.eventType==21">
        <div>
          ...
          <div class="warn-flex warn-line-h"><div class="warn-gray">年度</div><div  class="warn-ma">{{item.year}}</div></div>
          <div class="warn-flex warn-line-h"><div class="warn-gray"> 村民满意度</div><div  class="warn-ma">{{item.myd}}分</div></div>
      ...
      <!--<div class="warn-list">-->
        <!--<div>-->
          <!--<div class="warn-flex">-->
            ...
            <!--<div>-->
              <!--<div class="warn-flex">-->
                <!--<div class="warn-ma">张三</div><div class="warn-ma warn-font warn-gray">新安江街道-丰庆村 </div><div class="warn-ma warn-font warn-gray">党组织成员</div>-->
              <!--</div>-->
              <!--<div class="warn-ma warn-gray font-ma">-->
                <!--03月01日 08:30:00-->
              <!--</div>-->
            <!--</div>-->
          <!--</div>-->
          <!--<div class="warn-flex warn-line-h"><div class="warn-gray">年度</div><div  class="warn-ma">2020</div></div>-->
          <!--<div class="warn-flex warn-line-h"><div class="warn-gray"> 村民满意度</div><div  class="warn-ma">60分</div></div>-->
        ...
        <!--<div>-->
          <!--<div class="warn-flex">-->
            ...
            <!--<div>-->
              ...
              <!--</div>-->
              <!--<div class="warn-ma warn-gray font-ma">-->
                <!--03月01日 08:30:00    来源-有事找村里-->
              <!--</div>-->
            <!--</div>-->
          <!--</div>-->
          <!--<div class="warn-flex warn-line-h"><div class="warn-gray">评价度</div><div  class="warn-ma">1星</div></div>-->
          <!--<div class="warn-flex warn-line-h"><div class="warn-gray">已通知</div><div  class="warn-ma">新安江街道-丰庆村党组织书记</div><div  class="warn-ma">李四</div></div>-->
        <!--</div>-->
      <!--</div>-->
    </div>
