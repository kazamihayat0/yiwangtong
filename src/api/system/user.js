...
export const getList = (current, size, params, levelAreaCode) => {
  return request({
...
export const submitManager = (row) => {
  return request({
    url: '/api/blade-user/submitManager',
    method: 'post',
    data: row
  })
}
...
export const updateManager = (row) => {
  return request({
    url: '/api/blade-user/updateManager',
    method: 'post',
    data: row
  })
}
...
export const nameList = () => {
  return request({
    url: '/api/blade-user/searchByName',
    method: 'get',
  })
}
