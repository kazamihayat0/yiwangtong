    ...
    <div v-for="(item,index) in data">
      <div class="warn-list" >
        <div>
          ...
          <div class="warn-flex warn-line-h"><div class="warn-gray">入职日期</div><div  class="warn-ma">{{item.joinDate}}</div></div>
          <div class="warn-flex warn-line-h"><div class="warn-gray"> 最后工作日</div><div  class="warn-ma">{{item.happendTime }}</div></div>
          <div class="warn-flex warn-line-h"><div class="warn-gray"> 离职原因</div><div  class="warn-ma">{{item.text}}</div></div>
