    ...
    <div v-for="(item,index) in data">
      <div class="warn-list" v-if="item.eventType==12" >
        <div>
          ...
          <div class="warn-flex warn-line-h"><div class="warn-gray">前2周开会</div><div  class="warn-ma">{{item.szNum }}次</div></div>
      ...
      <div class="warn-list" v-if="item.eventType==13">
        <div>
          <div class="warn-flex">
            <div><img src="/img/cs.png"  width="50px" height="50px"/></div>
            <div>
          ...
          <div class="warn-flex warn-line-h"><div class="warn-gray">参会率</div><div  class="warn-ma">{{item.text  }}%</div></div>
          <div class="warn-flex warn-line-h" v-if="item.isPush!=0"><div class="warn-gray">已通知</div><div  class="warn-ma">{{item.pushInfo}}</div><div  class="warn-ma">{{item.postName}}</div></div>
        </div>
      ...
      <div class="warn-list" v-if="item.eventType==11">
        <div>
          ...
          <div class="warn-flex warn-line-h"><div class="warn-gray">未参会：</div><div  class="warn-ma">{{item.text  }}</div></div>
        </div>
      ...
      <div class="warn-list" v-if="item.eventType==21">
        <div>
          ...
          <div class="warn-flex warn-line-h"><div class="warn-gray"> 上月参会</div><div  class="warn-ma">{{item.sychNum }}次</div></div>
          <div class="warn-flex warn-line-h" v-if="item.isPush!=0"><div class="warn-gray">已通知</div><div  class="warn-ma">{{item.pushInfo}}</div><div  class="warn-ma">{{item.postName}}</div></div>
        </div>
