  ...
  <basic-container class="ele-info">
    <el-form class="r-stu" inline  :rules="rules" ref="FivePlan"   :model="FivePlan" label-width="100px"   size="small">
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="是否完成"   prop="isFinish" >
              <el-select    filterable   v-model="FivePlan.isFinish" placeholder="请选择" >
                <el-option
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="集体经济收入（万元）"  label-width="210px"  prop="collEconIncome" >
            <el-input-number v-model="FivePlan.collEconIncome" style="width: 100%"  :controls="false" ></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="经营性收入（万元）"  label-width="210px"  prop="operatingIncome" >
            <el-input-number v-model="FivePlan.operatingIncome" style="width: 100%"  :controls="false" ></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="村级债务（万元）"  label-width="210px"  prop="villageDebt" >
            <el-input-number v-model="FivePlan.villageDebt" style="width: 100%"  :controls="false" ></el-input-number>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="务工支出（万元）"  label-width="210px"  prop="laborExpenditure" >
            <el-input-number v-model="FivePlan.laborExpenditure" style="width: 100%"  :controls="false" ></el-input-number>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="农民人均可支配收入（万元）"  label-width="210px"  prop="perIncome" >
            <el-input-number v-model="FivePlan.perIncome" style="width: 100%"  :controls="false" ></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="实现村民福利达到"  label-width="210px"  prop="villWelfare" >
            <el-input v-model="FivePlan.villWelfare" style="width: 200%"   placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="发展年轻党员数（名）"  label-width="210px"  prop="youngPartyMembers" >
            <el-input-number v-model="FivePlan.youngPartyMembers" style="width: 100%"  :controls="false" ></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="争创荣誉等级"  label-width="210px"  prop="honorLevel" >
            <el-select filterable v-model="FivePlan.honorLevel" placeholder="请选择" style="width: 92%">
              <el-option
        ...
        <el-col :span="8">
          <el-form-item label="争创荣誉次数"  label-width="210px"  prop="honorsStriving" >
            <el-input-number v-model="FivePlan.honorsStriving" style="width: 100%"  :controls="false" ></el-input-number>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="“十支队”组织数（支）"  label-width="210px"  prop="teamNum" >
            <el-input-number v-model="FivePlan.teamNum" style="width: 100%"  :controls="false" ></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="“十支队”队员数（支）"  label-width="210px"  prop="peopleNum" >
            <el-input-number v-model="FivePlan.peopleNum" style="width: 100%"  :controls="false" ></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="产业试点项目数（个）"  label-width="210px"  prop="projectsNum" >
            <el-input-number v-model="FivePlan.projectsNum" style="width: 100%"  :controls="false" ></el-input-number>
          </el-form-item>
        </el-col>
      </el-row>
      <h4>工作计划</h4>
      ...
      <el-row v-for="(item,index) in FivePlan.mxList">
        <el-col :span="8">
          <el-form-item label=""  >
            <el-input v-model="item.projectName" style="width: 200%"   placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label=""  >
        ...
        <el-col :span="6">
          <el-form-item label=""  >
            <el-select    filterable   v-model="item.isFinish" placeholder="请选择" >
              <el-option
        ...
        <el-col  :span="4" >
          <el-form-item label=""   >
            <el-input v-model="item.responsible"  placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
