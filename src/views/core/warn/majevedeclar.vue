    ...
    <div v-for="(item,index) in data">
      <div class="warn-list">
        <div>
          ...
          <div class="warn-flex warn-line-h"><div class="warn-gray">事件类型</div><div  class="warn-ma">{{item.text}}</div></div>
          <div class="warn-flex warn-line-h"><div class="warn-gray"> 事件发生日期</div><div  class="warn-ma">{{item.happendTime }}</div></div>
          <div class="warn-flex warn-line-h"><div class="warn-gray"> 事项内容</div><div  class="warn-ma">{{item.remark   }}</div></div>
