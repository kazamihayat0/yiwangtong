    ...
    <div v-for="(item,index) in data">
      ...
      <div class="warn-list" v-if="item.eventType==11">
        <div>
          ...
          <div class="warn-flex warn-line-h"><div class="warn-gray">上季度开会</div><div  class="warn-ma">{{item.sykhNum}}次</div></div>
          <div class="warn-flex warn-line-h" v-if="item.isPush!=0"><div class="warn-gray">已通知</div><div  class="warn-ma">{{item.pushInfo}}</div><div  class="warn-ma">{{item.postName}}</div></div>
        </div>
      ...
      <div class="warn-list" v-if="item.eventType==12">
        <div>
          ...
          <!--<div class="warn-flex warn-line-h"><div class="warn-gray">上季度开会</div><div  class="warn-ma">1次</div></div>-->
          <div class="warn-flex warn-line-h"><div class="warn-gray">上季度参会率</div><div  class="warn-ma">{{item.text}}%</div></div>
          <div class="warn-flex warn-line-h"  v-if="item.isPush!=0"><div class="warn-gray">已通知</div><div  class="warn-ma">{{item.pushInfo}}</div><div  class="warn-ma">{{item.postName}}</div></div>
        </div>
