<template>
  <basic-container class="ele-info">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="姓名"   prop="userId" >
            <div class="el-oneRow">
              <el-select  disabled  filterable   v-model="UnqualifiedCadre.userId" placeholder="请选择" style="width: 93%">
                <el-option
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="停职教育期限" label-width="120px" prop="suspeEdu" :required="required1">
            <el-input disabled v-model="UnqualifiedCadre.suspeEdu" placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
          <el-form-item label="不合格原因" label-width="125px"  prop="reason" :required="required1">
            <el-input disabled  type="textarea" v-model="UnqualifiedCadre.reason" style="width: 610%" :rows="5"
        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item label="谈话人" prop="talkName" label-width="70px"   :required="required2" >
              <el-input  disabled v-model="UnqualifiedCadre.talkName"   style="width: 78%;"  placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
          ...
          <el-col :span="6">
            <el-form-item label="一对一帮教导师" label-width="80px"  prop="tutor"   :required="required2" >
              <el-input  disabled v-model="UnqualifiedCadre.tutor"  style="width:77%;"   placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item label-width="80px"  label="组织谈话教育情况" prop="orgEdu"   :required="required2" >
              <el-input  disabled  type="textarea" v-model="UnqualifiedCadre.orgEdu" style="width: 680%" :rows="5"
                        placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label-width="110px" label="实践表现" prop="practicePerf" :required="required3" >
              <el-input   disabled type="textarea" v-model="UnqualifiedCadre.practicePerf" style="width: 600%" :rows="5"
                        placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label-width="110px" label="基层党委意见" prop="grassrootsComm" :required="required4" >
              <el-input   disabled type="textarea" v-model="UnqualifiedCadre.grassrootsComm" style="width: 635%" :rows="5"
                        placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="党委书记签名" label-width="110px"  prop="signature"  :required="required4" >
              <el-input  disabled v-model="UnqualifiedCadre.signature" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="8">
            <el-form-item label="停职教育结果" label-width="110px"  prop="status" :required="required4"  >
              <el-select  disabled  @change="statusChange"   v-model="UnqualifiedCadre.status" placeholder="请选择"  style="width: 93%">
                <el-option
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="免职后职务" label-width="110px"  prop="postRemoval"  :required="required4" >
              <el-input  disabled v-model="UnqualifiedCadre.postRemoval" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="8" v-if="mzReasonShow">
            <el-form-item  label="免职原因" label-width="110px"  prop="removalReason" :required="required4"  >
              <el-select  disabled @change="eventTypeChange"    v-model="UnqualifiedCadre.removalReason" placeholder="请选择"  style="width: 93%">
                <el-option
          ...
          <el-col :span="8" v-if="mzReasonShow&&etyReasonShow">
            <el-form-item label="事件类型"  label-width="110px"  prop="eventType"  :required="required4" >
              <el-select   disabled  v-model="UnqualifiedCadre.eventType" placeholder="请选择"  style="width: 93%">
                <el-option
        ...
        <el-row v-if="mzReasonShow&&etyReasonShow">
          ...
          <el-col :span="16">
            <el-form-item label="事件描述" label-width="110px"  prop="eventDesc"  :required="required4" >
              <el-input disabled v-model="UnqualifiedCadre.eventDesc" style="width: 345%"  placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
    ...
    <div style="text-align: center">
      ...
      <el-button style="width: 100px" @click="handleBack()" size="medium" type="primary">关闭</el-button>
    </div>
  </basic-container>
</template>
      ...
      nameList().then(res=>{
        ...
        if (this.$route.query.id) {
          detail(this.$route.query.id).then(res => {
            this.UnqualifiedCadre=res.data.data;
            if(this.UnqualifiedCadre.level==0){
              this.sure()
            }
            if(this.UnqualifiedCadre.level==1){
              this.anno()
            }
            if(this.UnqualifiedCadre.level==2){
              this.edUp()
            }
            if(this.UnqualifiedCadre.level==3){
              this.resu()
            }
          })
        }
